...
os.chdir('/home/arthur/Documents/minizinc/color/data')
# print(os.getcwd())
...
os.remove('/home/arthur/Documents/minizinc/color/data/3data.dzn')
d3 = open('3data.dzn',"x")
str3 = "n = " + str(V) + " ; \ne = " + str(len(E)) + "; \n"+ start
d3.write(str3)
...
os.remove('/home/arthur/Documents/minizinc/color/data/2data.dzn')
d2 =open('2data.dzn',"x")
str2 = "n = "+ str(V) + " ; \ne = " + str(len(H)) + "; \n"+ start
d2.write(str2)
...
os.remove('/home/arthur/Documents/minizinc/color/data/1data.dzn')
d1 =open('1data.dzn',"x")
str1 = "n = "+ str(V) + " ; \ne = " + str(len(F)) + "; \n"+ start
d1.write(str1)
...
os.remove('/home/arthur/Documents/minizinc/color/data/0data.dzn')
d0 = open('0data.dzn',"x")
str0 = "n = "+ str(V)+ " ; \ne = " + str(len(G)) + "; \n"+ start
d0.write(str0)
