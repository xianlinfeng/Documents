...
public:
   /** constructor */
   ScipParaInstance(
         ) : scip(0), nVars(0), varIndexRange(0), mapToOriginalIndecies(0), mapToSolverLocalIndecies(0), mapToProbIndecies(0), orgScip(0)
   {
   }

   ScipParaInstance(
		 SCIP *inScip
         ) : scip(inScip), nVars(0), varIndexRange(0), mapToOriginalIndecies(0), mapToSolverLocalIndecies(0), mapToProbIndecies(0), orgScip(0)
   {
   }
   /** destractor */
